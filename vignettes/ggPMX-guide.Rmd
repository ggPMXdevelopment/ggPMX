...
knitr::opts_chunk$set(out.width='100%',warning=FALSE,message=FALSE,eval=FALSE)
...
```{r , individual_plot,  fig.width=7, fig.height=6, warning=FALSE,message=FALSE,eval=FALSE}
...
```{r , residual_plot,  fig.width=7, fig.height=6,message=FALSE,eval=FALSE}
...
```{r complete_example, warning=FALSE,  fig.width=7, fig.height=6,eval=FALSE}
library(ggPMX)
...
```{r update_plot,  fig.width=7, fig.height=6,eval=FALSE}
...
```{r pmx_filter,  fig.width=7, fig.height=6,eval=FALSE}
