...
```{r eta_box,message=FALSE,fig.align="center",fig.height=10, fig.width=10}
...
```{r eta_qq,message=FALSE,fig.align="center",fig.height=10, fig.width=10}
ctr %>% pmx_plot_eta_qq
```
...
```{r eta_cats,message=FALSE,fig.align="center",fig.height=10, fig.width=10}

ctr %>% pmx_plot_eta_cats
```

```{r eta_conts,message=FALSE,fig.align="center",fig.height=10, fig.width=10}
...
```{r npde_time_strats,fig.align="center",fig.height=10, fig.width=10}

ctr %>% pmx_plot_cats("npde_time")
```


```{r iwres_time_strats,fig.align="center",fig.height=10, fig.width=10}
ctr %>% pmx_plot_cats("iwres_time")


```

```{r vpc_strats,fig.align="center",fig.height=10, fig.width=10}
