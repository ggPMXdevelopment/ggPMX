...
We can mix ggPMX and no ggPMX plots under the same chunk. Note that here if we do not register pp we will not have the footnote under it. 

```{r ggpmx_no_ggpmx,pmx=TRUE}
pp
ctr %>% pmx_plot_ebe_box
```
